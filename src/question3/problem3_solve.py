...
df = pd.read_pickle(os.path.join(OUTPUT_DIR, 'merged_data.pkl'))
...
# 保存
# =============================================================================
df_uniform.to_pickle(os.path.join(OUTPUT_DIR, 'dispatch_uniform.pkl'))
df_waterfill.to_pickle(os.path.join(OUTPUT_DIR, 'dispatch_waterfill.pkl'))

np.savez(os.path.join(OUTPUT_DIR, 'dispatch_compare.npz'),
