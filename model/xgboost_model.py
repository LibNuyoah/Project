...
def evaluate_model(model, X_train, X_test, y_train, y_test, feature_names):
    ...
    full_metrics.to_excel(os.path.join(RESULT_DIR, 'tables', 'xgboost_metrics.xlsx'), index=False)
    print(f"\n✅ 评价指标已保存: {os.path.join(RESULT_DIR, 'tables', 'xgboost_metrics.xlsx')}")
...
def plot_evaluation(y_test, y_test_pred, imp_df, metrics_df, accuracy_info):
    ...
    plt.tight_layout()
    output_path = os.path.join(RESULT_DIR, 'figures', 'xgboost_evaluation.png')
